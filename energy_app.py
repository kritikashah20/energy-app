...
def main():
    ...
    if st.button("Predict Thermal Western"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", thermal_west)
    ...
    if st.button("Predict Nuclear Western"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", nuclear_west)
    ...
    if st.button("Predict Thermal Northern"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", thermal_north)
    ...
    if st.button("Predict Nuclear Northern"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", nuclear_north)
    ...
    if st.button("Predict Thermal Southern"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", thermal_south)
    ...
    if st.button("Predict Nuclear Southern"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", nuclear_south)
    ...
    if st.button("Predict Thermal NorthEastern"):
        st.subheader("User Data")
        st.write("Estimated value of Hydro energy", thermal_ne)
